...
- **Secure Backups**: Since data is local, the app provides an **AES-GCM Encrypted Backup** system. Export your entire database as a secure `.bgt` file, or export/import individual transactions via `.csv`.
